<template>
  <div class="main user-layout-register">
    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      <a-form-item>
        <a-input size="large" type="text" placeholder="请输入邮箱" v-decorator="['userEmail']"></a-input>
      </a-form-item>
      <a-form-item>
        <a-input size="large" type="text" placeholder="请输入昵称" v-decorator="['userName']"></a-input>
      </a-form-item>
      <a-form-item>
        <a-input size="large" type="text" placeholder="请输入密码" v-decorator="['userPassword']"></a-input>
      </a-form-item>
      <a-form-item>
        <a-input size="large" type="text" placeholder="请输入年纪" v-decorator="['userAge']"></a-input>
      </a-form-item>
