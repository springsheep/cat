 ...
 * @LastEditors: 张鹏
 * @LastEditTime: 2022-05-07 23:23:25
-->
<template>
  <a-list size="large" rowKey="id" :loading="loading" itemLayout="vertical" :dataSource="data">
   ...
   :description="item.commentContext"
      />
    </a-list-item>
...
import { commentquery, artd,articleadd1 } from '../api/login'
export default {
  name: 'Article',
  components: {
    IconText,
  ...
  methods: {
    ...
    getList(e={}) {
      commentquery({creatorId: localStorage.getItem('id') ,...e}).then((res) => {
